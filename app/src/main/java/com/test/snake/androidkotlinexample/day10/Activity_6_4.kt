...
import kotlinx.android.synthetic.main.activity_6_4.*
import org.jsoup.Jsoup
import java.nio.file.Files.size

class Activity_6_4 : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_6_4)
    ...
    private fun setUpUI() {
        btnOk!!.setOnClickListener {
            ...
            try {
                ...
                txtMessage!!.text = tsk.GET_HTML_RESPONSE
    ...
    fun getHomepageInfo(): String {

        // Jsop을 이용해 URL의 HTML 소스를 가져온다.
        val document = Jsoup.connect("http://www.daum.net").get()
